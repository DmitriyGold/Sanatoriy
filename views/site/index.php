        ...
        <div class="container-fluid">
            <div class="row my-4 text-center">
                ...
                <div class="col-12 text-center align-self-end pt-2">
                    ...
                    <?= Html::a('подробнее <i class="fa fa-angle-double-right" aria-hidden="true"></i>', ['mainnews'], $options) ?>
                </div>
            </div>
        </div>
    <?php } ?>
...
<?php if (!empty($promotions)) { ?>
        <div class="container">
            ...
            <div class="row my-4 justify-content-center" style="display: flex;">

                <!-- Если акций много вставляем картинку "акциИ" -->
    <?php $var1 = (count($promotions) == 1) ? 'images/promotions.jpg' : 'images/promotions.png'; ?>  
    <?php $var2 = (count($promotions) == 1) ? '2' : '1'; ?>     
                <img src="<?= Url::to('@web/' . $var1) ?>" alt="картинка к акции"  
                     style="width: 200px; position: relative; top: <?= $var2; ?>.0em; z-index: 1;">
            </div>
        </div>

        <div class="container-fluid block_backg1">
        ...
        <?= Html::a('подробнее <i class="fa fa-angle-double-right" aria-hidden="true"></i>', ['promotion', 'id' => $value['id']], $options) ?>
            ...
            <div class="row justify-content-center mt-3 mb-5">
                <a href="<?= Url::to(['/site/promotions']); ?>">
                    <button type="button" class="my-btn1 mb-1" data-toggle="modal" data-target="#myModal_Contact">
                        все акции и предложения</button>
                </a>
            </div>   
...
<?php if (!empty($news)) { ?>
        <div class="container-fluid">
            ...
            <div class="row my-4 justify-content-center">
                <h3><i class="fa fa-newspaper-o" aria-hidden="true"></i> НОВОСТИ:</h3>
            </div>

            <div class="row justify-content-center" >

    <?php $i = 0 ?> <!-- организация счетчика новостей, покажем только 3 последние-->
    <?php foreach ($news as $value) { ?>
                    <div class="col-12 col-xl-4" style="height: 410px;">

                        <div class="col text-center shadow bg-white rounded block-news" style="height: 356px; overflow: hidden;">
                            <div class="col pt-2  pb-1 text-right border-bottom">
                                <i class="fa fa-calendar" aria-hidden="true"></i>
        <?= $value['date'] ?>
                            </div>
                            <div class="col pt-3" style="color: #79A62F; max-height:  92px; overflow: hidden;">
                                <h6><?= mb_strtoupper($value['title'], 'UTF-8') ?></h6>
                            </div>
                            <div class="col pt-2" style="max-height:  214px;     overflow: hidden;">
                                <p><i><?= nl2br($value['short_text']) ?></i></p>
                            </div>
                        </div>
                        <div class="col p-2 text-center align-self-end" style="height: 40px;">
        <?php $options = ['style' => ['color' => '#888']]; ?>
                    <?= Html::a('подробнее <i class="fa fa-angle-double-right" aria-hidden="true"></i>', ['news', 'id' => $value['id']], $options) ?>
                        </div>
                    </div>
                    <?php
                    $i++;
